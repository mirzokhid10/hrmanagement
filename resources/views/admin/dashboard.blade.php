        ...
        <div class="col-xxl-3">
            <div class="card overflow-hidden z-1">
                <div class="card-body">
                    ...
                    <img src="assets/images/media/svg/media1.html" alt=""
            ...
            <div class="card">
                ...
                <div class="card-body pb-3">
                    <ul class="list-group list-group-hover list-group-smooth list-group-unlined list-group-outer">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="avatar rounded-circle me-1">
                                <img src="assets/images/avatar/avatar4.html" alt="">
                            </div>
                            <div class="ms-2 me-auto">
                    ...
                    <div class="card-body gradient-layer" style="height: 325px;" data-simplebar>
                        <div class="p-3 bg-light bg-opacity-50 mb-2 rounded">
                            ...
                            <div class="text-2xs d-flex gap-1 align-items-center">
                                <img src="assets/images/icons/google-meet.html" alt="">
                            ...
                            <div class="modal-body">
                                <form id="taskForm">
                                    <input type="hidden" name="_token"
                                        value="J7J96OM8aImI0yyKVZvzAkQ6w2NAhQ0eBNE0PWCG" autocomplete="off">
                                    <div class="row">
    ...
    <div class="modal fade" id="addEmployeeModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <input type="hidden" name="_token" value="J7J96OM8aImI0yyKVZvzAkQ6w2NAhQ0eBNE0PWCG"
                            autocomplete="off">
                        <div class="mb-3">
