    ...
    <div class="app-header-inner">
        ...
        <div class="app-header-start">
            <form class="d-none d-md-flex align-items-center h-100 w-lg-250px w-xxl-300px position-relative"
                action="#">
                <input type="hidden" name="_token" value="J7J96OM8aImI0yyKVZvzAkQ6w2NAhQ0eBNE0PWCG" autocomplete="off">
            ...
            <ul class="navbar-nav gap-4 flex-row d-none d-xxl-flex">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="faqs.html">Help</a>
                </li>
            </ul>
        </div>
        <div class="app-header-end">
            ...
            <div class="dropdown text-end ms-sm-3 ms-2 ms-lg-4">
                <a href="javascript:void(0);" class="d-flex align-items-center py-2" data-bs-toggle="dropdown"
                ...
                <ul class="dropdown-menu dropdown-menu-end w-225px mt-1">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2" href="faqs.html">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2" href="pricing.html">
